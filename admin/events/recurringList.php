...
<body>
  ...
  <button type="button" class="btn btn-primary" onclick="javascript:history.back();" style="float: right;margin-right:1em;">Back</button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>This will bring you to a page that will update all the associated events. This will even change events you may have already updated. Are you sure you would like to continue?</p>
      </div>
