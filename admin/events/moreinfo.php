...
<script>
  <?php
    ...
    <div class="container-fluid">
        ...
        <form class="form-group" id="info" name="info" method="post" action="server/saveEvent.php" enctype="multipart/form-data">
            <div class="row mb-3">
                <div class="col-xs-12 col-md-4 text-md-right">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button type="button" onclick=deleteEvent() class="btn btn-danger btn-sm">Decline</button>
        </div>
      </div>
    </div>
    </div>
